...
- Supabase-ready client plus UI for operations (tickets, bookings, roster), finance (revenue/expenses/profit/tax), HR/payroll (hours, payroll, attendance), commerce (products/orders/payments), and access control (user management).
